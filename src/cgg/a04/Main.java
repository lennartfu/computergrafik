...
public class Main {
    ...
    private static void generateImage1() {
        ...
        Shape ground = new Plane(point(0.0, -0.5, 0.0), direction(0, 1, 0), Double.POSITIVE_INFINITY, new Color(1, 0.6, 1));
        Shape globe1 = new Sphere(point(-1.0, -0.25, -3.5), 0.7, new Color(1, 0.15, 0.15));
        Shape globe2 = new Sphere(point(0.0, -0.25, -3.5), 0.5, new Color(0.4, 1, 0.4));
        Shape globe3 = new Sphere(point(1.0, -0.25, -3.5), 0.7, new Color(0.3, 0.65, 1));
    ...
    private static void generateImage2() {
        ...
        shapes.add(new Background(new Color(0, 0, 0)));
        shapes.add(new Sphere(point(-8, -27, -30), 27, new Color(0.4, 0.05, 0.0)));
        shapes.add(stars());
        shapes.add(craters());
    ...
    private static Group stars() {
        ...
        for (int i = 0; i < 500; i++) {
            ...
            stars.add(new Sphere(point(x, y, z), radius, new Color(1, 1, 1)));
        }
    ...
    private static Plane crater(int x, int y) {
        Sphere planet = new Sphere(point(-8, -27, -30), 27, new Color(0.4, 0.05, 0.0));
        Ray r = camera.generateRay(x, y);
        Hit h = planet.intersect(r);
        return new Plane(add(direction(0, 0.0001, 0), h.position()), h.normal(), random() * 0.9 + 0.2, new Color(0.2, 0.025, 0));
    }
    ...
    private static Group starTemplate() {
        List<Shape> stars = new ArrayList<>();
        stars.add(new Sphere(point(-55, 30, -100), 0.4, new Color(1, 1, 0)));
        stars.add(new Sphere(point(55, 30, -100), 0.4, new Color(1, 1, 0)));
        stars.add(new Sphere(point(-55, -30, -100), 0.4, new Color(1, 1, 0)));
        stars.add(new Sphere(point(55, -30, -100), 0.4, new Color(1, 1, 0)));
        stars.add(new Sphere(point(-10, 0, -100), 0.1, new Color(1, 1, 0)));
        stars.add(new Sphere(point(-5, 0, -100), 0.2, new Color(1, 1, 0)));
        stars.add(new Sphere(point(0, 0, -100), 0.3, new Color(1, 1, 0)));
        stars.add(new Sphere(point(5, 0, -100), 0.4, new Color(1, 1, 0)));
        stars.add(new Sphere(point(10, 0, -100), 0.5, new Color(1, 1, 0)));
        return new Group(stars);
    }
}
